...
class ActionPlacesSearch(Action):
    def __init__(self) -> None:
        ...
        self.code_dict = {'restaurants': '13065', 'coffee houses': '13032',
                          'both restaurants and coffee houses': '13065,13032'}
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        try:
            ...
            bot_response = '\n\n'.join(
                df.apply(lambda x: f"Name: {x['name']} | Address: {x['address']} | Distance: {x['distance']} km",
                         axis=1))
        except:
